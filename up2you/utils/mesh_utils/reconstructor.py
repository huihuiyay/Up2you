...
class Reconstructor:
    def __init__(
        self,
        device,
        normal_views=[0, 30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 330],
        color_views=[0, 30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 330],
        scale=2.0,
        resolution=1024,
        iters=700,
    ) -> None:
        ...
        # 对称权重：前后(0°/180°)=1.0, 左右(90°/270°)=0.8, 对角线=0.6
